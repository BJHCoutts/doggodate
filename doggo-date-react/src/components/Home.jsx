...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <h2>Arf!</h2>
      <p>
        He made many woofs bork aqua doggo noodle horse vvv sub woofer, tungg ur
        givin me a spook woofer blop you are doing me a frighten blep, borkdrive
        he made many woofs such treat heckin good boys. Stop it fren heck many
        pats vvv, dat tungg tho ruff. You are doin me a concern doggo stop it
        fren smol noodle horse shoober pupper, heckin good boys and girls what a
        nice floof dat tungg tho very taste wow. Doing me a frighten boof
        puggorino puggo blop, woofer corgo wow very biscit.
      </p>
      <h2>Woof!</h2>
      <p>
        Very hand that feed shibe much ruin diet heckin good boys and girls very
        good spot, such treat. Bork borking doggo heckin angery woofer stop it
        fren doge, pats heckin good boys and girls. Mlem shoob bork lotsa pats
        snoot, you are doin me a concern boofers waggy wags you are doing me a
        frighten shooberino, most angery pupper I have ever seen doggorino smol
        borking doggo with a long snoot for pats. Snoot doge big ol, shibe.
        Noodle horse sub woofer porgo he made many woofs corgo you are doin me a
        concern, extremely cuuuuuute aqua doggo fluffer mlem. Pats much ruin
        diet thicc corgo, tungg very hand that feed shibe. pats shoober. Waggy
        wags super chub heck the neighborhood pupper long bois, snoot doggo. Big
        ol pupper lotsa pats doggorino pupperino such treat shoober mlem, thicc
        I am bekom fat super chub wrinkler.
      </p>
      <h2>Yipp!</h2>
      {/* </div> */}
      <div className="bar" />
